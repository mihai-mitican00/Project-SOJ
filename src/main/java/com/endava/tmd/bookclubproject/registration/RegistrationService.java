...
public class RegistrationService {
    ...
    public String register(final RegistrationRequest request)  {
        ...
        emailSender.sendEmail(request.getEmail(), buildEmail(request.getFirstName(), activationLink));
    ...
    public String confirmToken(final String token) {
        ...
        if (LocalDateTime.now().isAfter(expiredAt)) {
            throw new ApiBadRequestException("Token is expired!");
        }
    ...
    private boolean isEmailValid(final String email) {
        String validEmailRegex = "[a-zA-Z]+[_|.]?[a-zA-Z]+@endava.com";
